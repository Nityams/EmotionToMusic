...
"""
# listOfArtist = [SlowStridePianist, BassInstrument, FastStridePianist]
# trial1 = [listOfArtist[0]({'max_velocity': 80, 'start': 0, 'step': 2 })]
...
sadKaran = [
	SlowStridePianist({'channel': 1, 'midi_instr': 10, 'start': 0, 'step': 8,  'max_velocity': 220}),
	SlowStridePianist({'channel': 2, 'midi_instr': 2, 'start': 1, 'step': 4,  'max_velocity': 110}),
	]

sadKaran1 = [
	SlowStridePianist({'channel': 1, 'midi_instr': 69, 'start': 2, 'step': 3,  'max_velocity': 110}),
	SlowStridePianist({'channel': 2, 'midi_instr': 20, 'start': 1, 'step': 4,  'max_velocity': 110}),
	]

sadKaran2 = [
	SlowStridePianist({'channel': 14, 'midi_instr': 69, 'start': 2, 'step': 3,  'max_velocity': 110}),
	SlowStridePianist({'channel': 13, 'midi_instr': 72, 'start': 1, 'step': 4,  'max_velocity': 110}),
	]
